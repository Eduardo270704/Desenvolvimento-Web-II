...
export class Default1693959094752 implements MigrationInterface {
    name = 'Default1693959094752'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rents" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL, "ownervaluation" integer NOT NULL, "clientvaluation" integer, "idbike" integer, "iduser" integer, CONSTRAINT "PK_43a9961f1448a8d75f9b25156ea" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "alias" character varying(15) NOT NULL, "mail" character varying(50) NOT NULL, "phone" character varying(20) NOT NULL, CONSTRAINT "UQ_f002c336d3299ee4eba00196902" UNIQUE ("alias"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "bikes" ("id" SERIAL NOT NULL, "color" character varying(30) NOT NULL, "size" character varying(10) NOT NULL, "material" "public"."bikes_material_enum" NOT NULL, "gender" "public"."bikes_gender_enum" NOT NULL, "speedkit" integer NOT NULL, "aro" character varying(10) NOT NULL, "suspensao" boolean NOT NULL, "hourlyvalue" integer NOT NULL, "dailyvalue" integer NOT NULL, "description" character varying(200) NOT NULL, "idbrand" integer, "idcategory" integer, "iduser" integer, CONSTRAINT "PK_5237c1fcb162998a0d31e640814" PRIMARY KEY ("id"))`);
